...
<div class="container">
	<h1>Your access to this site has been temporarily limited by the site owner</h1>
	...
	<table border="0" cellspacing="0" cellpadding="0" class="block-data">
		<tr>
			...
			<td class="reason">You have been temporarily locked out of this system. This means that you will not be able to log in for a while.</td>
		</tr>
		<tr>
	...
	<div class="about">
		...
		<div class="about-text">
			...
			<p>Wordfence is a security plugin installed on over 3 million WordPress sites. The owner of this site is using Wordfence to manage access to their site.</p>
	...
	<p class="generated small"><em>Generated by Wordfence at <?php echo gmdate('D, j M Y G:i:s T', wfWAFUtils::normalizedTime()); ?>.<br>Your computer's time: <script type="application/javascript">document.write(new Date().toUTCString());</script>.</em></p>
</div>
</body>
</html>
